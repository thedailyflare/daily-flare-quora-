...
class MainActivity : Activity() {
 ...
 private fun addCard(story:Story,number:Int){
  ...
  socialRow.addView(Space(this).apply{minimumWidth=dp(7)})
   socialRow.addView(socialIcon("in",Color.rgb(10,102,194),"linkedin"){ val postText = story.title + "\n\n" + ex + "\n\n" + story.link; try { startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://www.linkedin.com/feed/?shareActive=true")).setPackage("com.linkedin.android")) } catch(e: Exception) { shareToApp("com.linkedin.android", postText, "LinkedIn") } },LinearLayout.LayoutParams(0,dp(46),1f))
